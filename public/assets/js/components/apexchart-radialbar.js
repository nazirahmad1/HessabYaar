/**
 * تم: Larkon - داشبورد مدیریت واکنش‌گرا با Bootstrap 5
 * نویسنده: Techzaa
 * ماژول/برنامه: نمودارهای رادیال بار آپکس
 */
//
// نمودار رادیال بار پایه
//
var colors = ["#7f56da"];
var options = {
    chart: {
...
var options = {
    ...
    colors: colors,
    series: [76, 67, 61, 90],
    labels: ['آپارات', 'مسنجر', 'فیسبوک', 'لینکدین'],
    legend: {
        show: true,
        floating: true,
        fontSize: '13px',
