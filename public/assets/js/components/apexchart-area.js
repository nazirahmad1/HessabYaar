...
// Be sure to define dataSeries or load it from your data source
var dataSeries = [
  Array.from({ length: 12 }, (_, i) => ({ value: (i + 1) * 1000000 })), // Placeholder data for Product C
  Array.from({ length: 18 }, (_, i) => ({ value: (i + 1) * 2000000 })), // Placeholder data for Product B
  Array.from({ length: 12 }, (_, i) => ({ value: (i + 1) * 3000000 }))  // Placeholder data for Product A
];
...
for (var i = 0; i < 12; i++) {
  ts1 = ts1 + 86400000; // Increment by one day
  var innerArr = [ts1, dataSeries[2][i].value]; // Product C data
  dataSet[0].push(innerArr);
}
for (var i = 0; i < 18; i++) {
  ts2 = ts2 + 86400000; // Increment by one day
  var innerArr = [ts2, dataSeries[1][i].value]; // Product B data
  dataSet[1].push(innerArr);
}
for (var i = 0; i < 12; i++) {
  ts3 = ts3 + 86400000; // Increment by one day
  var innerArr = [ts3, dataSeries[0][i].value]; // Product A data
