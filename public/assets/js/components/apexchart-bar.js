/**
 * تم: Larkon - داشبورد مدیریتی ریسپانسیو Bootstrap 5
 * نویسنده: Techzaa
 * ماژول/برنامه: نمودارهای میله‌ای Apex
 */
...
var options = {
  ...
  xaxis: {
    categories: ["جولای", "اوت", "سپتامبر", "اکتبر", "نوامبر", "دسامبر", "ژانویه"],
  },
  colors: colors,
  grid: {
    xaxis: {
...
var options = {
  ...
  fill: {
    ...
    opacity: 1,
    pattern: {
      style: ["circles", "slantedLines", "verticalLines", "horizontalLines"], // رشته یا آرایه‌ای از رشته‌ها
    },
  },
  states: {
    hover: {
...
//
// نمودار میله‌ای با پر کردن تصویر
//
...
//
// نمودار میله‌ای با برچسب‌های سفارشی
//
