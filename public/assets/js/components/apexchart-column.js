 ...
 * نویسنده: Techzaa
 * ماژول/برنامه: نمودارهای ستونی Apex
 */
...
var options = {
    ...
    xaxis: {
        categories: ['فوریه', 'مارس', 'آوریل', 'مه', 'ژوئن', 'ژوئیه', 'اوت', 'سپتامبر', 'اکتبر'],
    },
    legend: {
        offsetY: 7,
    },
    ...
    grid: {
        row: {
            colors: ['transparent', 'transparent'], // یک آرایه که در ستون‌ها تکرار خواهد شد
            opacity: 0.2
        },
        borderColor: '#f1f3fa',
        padding: {
...
var options = {
    ...
    legend: {
        ...
        customLegendItems: ['واقعی', 'انتظار'],
        markers: {
            fillColors: colors
        }
    }
...
//
// نمودار ستونی با برچسب‌های چرخان و یادداشت‌ها
//
var colors = ["#f9b931"];
var options = {
    annotations: {
    ...
    xaxis: {
        ...
        categories: ['سیب‌ها', 'پرتقال‌ها', 'توت‌فرنگی‌ها', 'آناناس‌ها', 'موزها', 'تمشک‌ها',
            'گلابی‌ها', 'هندوانه‌ها', 'گیلاس‌ها', 'انارها', 'نارنگی‌ها', 'پاپایاها'
        ],
    },
    yaxis: {
        title: {
...
var options = {
    ...
    xaxis: {
        // TODO: کامنت زیر را باز کرده و خطا را برطرف کنید
        //type: 'datetime',
        categories: [
...
var options = {
    ...
    xaxis: {
        categories: ['جان', 'جو', 'جیک', 'امبر', 'پیتر', 'مری', 'دیوید', 'لیلی'],
        labels: {
            style: {
                colors: colors,
                fontSize: '14px'
...
/**
 * ترتیب عناصر آرایه را به صورت تصادفی تغییر می‌دهد.
 * با استفاده از الگوریتم شافل دورستنفلد.
 */
...
var options = {
    ...
    subtitle: {
        text: '(برای مشاهده جزئیات روی نوار کلیک کنید)',
        offsetX: 15
    },
    yaxis: {
        labels: {
